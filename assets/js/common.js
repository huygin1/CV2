...
$(document).ready(function() {
    ...
    $(".formus").validator().on("submit", function (event) {
    ...
    $(".formvn").validator().on("submit", function (event) {
        if (event.isDefaultPrevented()) {
            formError();
            submitMSG(false, "Vui lòng điền vào biểu mẫu...");
        } else {
            event.preventDefault();
            submitMSG(true, "Biểu mẫu đã được gửi đi...");
            submitForm();
        }
    });
    function submitForm(){
